    ...
    return (
        <div className="hidden md:block">
            <Button
                ...
                className={cn(
                    "bg-card mx-auto flex min-h-32 w-full max-w-32 cursor-pointer flex-col items-center justify-start rounded-xl border p-3 shadow-sm transition-all disabled:opacity-100 lg:p-4 xl:p-5",
